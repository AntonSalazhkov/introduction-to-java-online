...
public class Account {
    ...
    private String directoryAccounts = "src\\by\\training\\java\\module_6\\task01\\user\\Accounts.txt";
    ...
    public String toString() {
        ...
        return "Вы вошли под логином: " + getUsername() + ", ваша почта: " + getEmail() + ", ваш статус: " + getUserStatus();
    }
    ...
    public void readAccount() {
        ...
        try (FileReader fr = new FileReader(getDirectoryAccounts())) {
            ...
            while (scan.hasNextLine()) {
                ...
                // добавляем сохраненные аккаунды из файла в ArrayList
